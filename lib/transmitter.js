...
transmitter.connect = function connect(cb) {
  ...
  transmitter.client.on('message', (topic, payload) => {
    log.debug(`Received Message:- ${topic}: ${payload.toString()}`);
